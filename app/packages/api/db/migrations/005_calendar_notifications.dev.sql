-- FMIQ migration 005 — calendar/booking + notifications — DEV variant. Mirrors prod.
BEGIN;
...
CREATE INDEX ix_ntf_message_unread ON ntf_message (tenant_id, sent_at) WHERE read_at IS NULL;
